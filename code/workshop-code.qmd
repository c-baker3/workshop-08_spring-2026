...
# created new object from drought_exp
drought_exp_clean <- drought_exp |> 
  # makes column names snake case and replaces spaces with underscores
  clean_names() |> 
...
slice_sample(
  drought_exp_clean, # cleaned data frame to display
...
ggplot(data = drought_exp_clean,
       ...
       # y-axis: total mass 
       # colored geometries by water treatment
  ...
  scale_color_manual(values = c(
    ...
    "Well watered" = ww_col)) + 
  # added title and relabeled axes
...
ggplot(data = drought_exp_clean,
       # x-axis: species
       # y-axis: plant mass
       # colored by species name
       mapping = aes(x = species_name,
                     y = total_g,
                     color = species_name)) +
  # representing individuals in each species 
  geom_jitter(height = 0,
              width = 0.1) + 
  ...
  scale_color_manual(
    values = c(
      ...
      "Pentsemon centranthifolius" = pencen_col,
      "Salvia leucophylla" = salleu_col,
      "Encelia california" = enccal_col,
...
- `water_treatmentWell watered`: The model prediction for the difference in Lotus scoparius mass between well watered and drought stressed treatments. 
- `species_namePenstemon centranthifolius`: The model prediction for the difference between Penstemon mass in the well water treatment and Lotus scoparius mass in the well watered treatment. 
- `species_nameEschscholzia californica`: difference between Eschscholzia californica mass in the well watered treatment and Lotus scoparius mass in the well watered treatment.
